...
//	@Test(priority = 1)
	...
	@Test(priority = 3)
	void Story() {
		//List<WebElement> list=driver.findElements(By.xpath("//h2[text()='Trending']/..//child::div//child::div[@class='grid  svelte-ooozxy']//child::span"));
	...
	////h2[text()='Trending']/..//child::div//child::div[@class='grid  svelte-ooozxy']
		////h2[text()='Trending']/..//child::div//child::div[@class='grid  svelte-ooozxy']//child::a
		//h2[text()='Trending']/..//child::div//child::div[@class='grid  svelte-ooozxy']//child::span
	}
